        ...
        <div className={styles.widecard}>
            ...
            <div className={styles.widecardData}>
                ...
                <div className={styles.price}>
                    <span>$</span><p >{parseInt(product.price)}</p><span>{centsValue}</span>
                </div>     
                <p className={styles.colors}>Color: <span>light green</span></p>
                <p className={styles.size}>Size: <span>Medium</span></p>
